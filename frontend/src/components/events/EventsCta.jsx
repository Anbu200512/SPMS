...
import { HiOutlineCalendarDays, HiOutlineMegaphone } from 'react-icons/hi2';
    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-primary-700 via-primary-600 to-primary-500 py-20">
      ...
      >
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-white mb-6">
          Don't Miss an <span className="text-accent-400">Event</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-200 mb-10 leading-relaxed">
          Subscribe to our event calendar and be the first to know about upcoming activities, 
          workshops, and celebrations at St. Paul's School.
        </p>
