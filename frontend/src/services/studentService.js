...
export const getMyPayments = () => api.get('/fees/payments/mine');
export const createFeeCheckout = (feeId) => api.post(`/fees/${feeId}/checkout`);
export const getPaymentStatus = (orderId) => api.get(`/fees/payment/status/${orderId}`);
